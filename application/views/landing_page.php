               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>Selmat datang di aplikasi Sistem Informasi Penggajian Karyawan <br>Yayasan Wakaf Cendekia Takengon</p>
                     </div>
                  </div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan Yayasan Wakaf Cendekia Takengon</div>
            </div>
                  ...
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        ...
                        <div class="TeamInfo text-center">
                           ...
                           <div class="Job">Yayasan Wakaf Cendekia Takengon</div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; Syafari | Penggajian 2025 - All Rights Reserved
               </div>
            </div>
         </div>
      </div>
