<?php
// ============================================================
// FILE: application/controllers/admin/Data_Absensi.php
// ============================================================
class Data_Absensi extends MY_Controller {
    ...
    public function index()
    {
        ...
        if($my_unit) {
            // Kepala unit: hanya absensi unitnya
            $data['absensi'] = $this->db->query(
                "SELECT dk.*, dp.nama_pegawai, dp.jenis_kelamin, dp.jabatan
                 ...
                 WHERE dk.bulan='$bulantahun' AND dp.unit='$my_unit'
    ...
    public function input_absensi()
    {
        ...
        $data['input_absensi'] = $this->db->query(
            "SELECT dp.*, dj.nama_jabatan FROM data_pegawai dp
             INNER JOIN data_jabatan dj ON dp.jabatan = dj.nama_jabatan
             WHERE NOT EXISTS (SELECT * FROM data_kehadiran WHERE bulan='$bulantahun' AND dp.nik=data_kehadiran.nik)
             $unit_filter
             ORDER BY dp.nama_pegawai ASC"
        )->result();
...
// ============================================================
// FILE: application/controllers/admin/Data_Jabatan.php
// ============================================================
class Data_Jabatan extends MY_Controller {
    ...
    public function update_data_aksi() {
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            $this->ModelPenggajian->update_data('data_jabatan', $data, array('id_jabatan' => $id));
...
// ============================================================
// FILE: application/controllers/admin/Data_Penggajian.php
// ============================================================
...
// ============================================================
// FILE: application/controllers/admin/Penilaian_Karyawan.php
// ============================================================
class Penilaian_Karyawan extends MY_Controller {
    ...
    public function index()
    {
        ...
        $data['penilaian'] = $this->db->query(
            "SELECT dpn.* FROM data_penilaian dpn
    ...
    public function input_penilaian()
    {
        ...
        $data['input_penilaian'] = $this->db->query(
            "SELECT dp.*, dj.nama_jabatan FROM data_pegawai dp
             INNER JOIN data_jabatan dj ON dp.jabatan = dj.nama_jabatan
             WHERE NOT EXISTS (SELECT * FROM data_penilaian WHERE bulan='$bulantahun' AND dp.nik=data_penilaian.nik)
             $unit_filter
             ORDER BY dp.nama_pegawai ASC"
        )->result();
    ...
    public function edit_penilaian_aksi()
    {
        ...
        $this->ModelPenggajian->update_data('data_penilaian', $data, array('id_penilaian' => $id));
...
// ============================================================
// FILE: application/controllers/admin/Laporan_Absensi.php
// ============================================================
class Laporan_Absensi extends MY_Controller {
    ...
    public function cetak_laporan_absensi(){
        ...
        $data['lap_kehadiran'] = $this->db->query(
            "SELECT dk.* FROM data_kehadiran dk
             INNER JOIN data_pegawai dp ON dk.nik = dp.nik
             WHERE dk.bulan='$bulantahun' $unit_filter
...
// ============================================================
// FILE: application/controllers/admin/Laporan_Gaji.php
// ============================================================
...
// ============================================================
// FILE: application/controllers/admin/Slip_Gaji.php
// ============================================================
class Slip_Gaji extends MY_Controller {
    ...
    public function index() {
        ...
        $my_unit         = $this->get_my_unit();
        $unit_filter     = $my_unit ? "WHERE unit='$my_unit'" : "";
        $data['pegawai'] = $this->db->query("SELECT * FROM data_pegawai $unit_filter ORDER BY nama_pegawai ASC")->result();
...
// ============================================================
// FILE: application/controllers/admin/Potongan_Gaji.php
// ============================================================
